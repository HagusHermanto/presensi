...
<div class="section mt-2" id="presence-section" style="background-color:#eed5db;">
    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.5rem; z-index:999">{{ $rekapizin->jmlizin }}</span>
                        <ion-icon name="newspaper" style="font-size: 1.5rem;" class="text-success mb-1"></ion-icon>
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.5rem; z-index:999">{{ $rekapizin->jmlsakit }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        ...
                        <ion-icon name="alarm" style="font-size: 1.5rem;" class="text-danger mb-1"></ion-icon>
                        <br>
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                ...
                                <span class="badge {{ $d->jam_in < "10:00" ? "bg-success" : "bg-danger" }}">{{ $d->jam_in }}</span>
                            </div>
                        </div>
                    </li>
                    @endforeach
